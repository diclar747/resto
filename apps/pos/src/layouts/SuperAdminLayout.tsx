...
import {
    ...
    ArrowLeft, LogOut, Settings, Bell, Search, User, FileText
} from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <header className="h-20 bg-white/70 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-8 z-10 sticky top-0">
                    ...
                    <div className="flex items-center gap-4 ml-auto">
                        ...
                        <button className="w-10 h-10 flex items-center justify-center rounded-xl text-gray-400 hover:bg-gray-50 hover:text-indigo-600 transition-all">
                            <Settings size={20} />
                        </button>
                    </div>
                </header>
