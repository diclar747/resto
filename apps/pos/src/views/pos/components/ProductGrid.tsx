        ...
        >
          <div className="product-image-container">
            {product.imageUrl ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 text-[var(--text-secondary)]/30 italic font-medium">
                Sin Imagen
              </div>
            )}
            <div className="absolute top-4 right-4 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
              <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center text-[var(--primary)] shadow-lg active:scale-90">
                <Plus size={20} />
              </div>
            </div>
          </div>
          ...
          <div className="p-5 flex-1 flex flex-col justify-between">
            <div>
              <h3 className="font-black text-[var(--text-main)] text-base group-hover:text-[var(--primary)] transition-colors line-clamp-2 leading-tight">
                {product.name}
              </h3>
              {product.description && (
            ...
            <div className="mt-4 pt-4 border-t border-gray-50 flex items-end justify-between">
              {product.variants.length === 1 ? (
                ...
                <div className="flex flex-col w-full gap-2">
                  <p className="text-[10px] uppercase tracking-widest font-black text-[var(--text-secondary)]">Varios Precios</p>
